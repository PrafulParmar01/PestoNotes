...
val keystorePropertiesFile = project.property("pesto.properties")
...
android {
    ...
    namespace = "com.pesto.task.management"
    compileSdk = 33

    defaultConfig {
        applicationId = "com.pesto.task.management"
        minSdk = 21
        targetSdk = 33
        versionCode = 1
        versionName = "1.0.0"
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                val outputFileName = "Pesto_Notes_v$versionName($versionCode)_${buildDate}.${output.outputFile.extension}"
                output.outputFileName = outputFileName
            }

        val aabPackageName = "Pesto_Notes_v$versionName($versionCode)_${buildDate}.aab"
